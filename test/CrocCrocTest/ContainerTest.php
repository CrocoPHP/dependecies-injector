...
use CrocCroc\Container\Container;
...
class ContainerTest extends \PhpunitTestCase
{
    ...
    public function testGetSingleton() {
        ...
        $mockClass   = $this->getMock(\CrocCroc\Container\Service\SingletonInterface::class);

        $className = get_class($mockClass);

        $this->setInaccessiblePropertyValue('storedNextObject' , true);
